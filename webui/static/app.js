...
async function inspectUpgrade(value) {
  ...
  if (value.version_relation === 'downgrade' && !ui.upgradeAllowDowngrade) {
    output.textContent = `检测到较旧版本 ${value.version}；如需降级，请先启用“允许降级”。`;
